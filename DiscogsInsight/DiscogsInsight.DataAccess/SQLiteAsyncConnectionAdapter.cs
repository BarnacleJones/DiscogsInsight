...
{
    public class SQLiteAsyncConnectionAdapter : ISQLiteAsyncConnection
    {
        ...
        {
            _connection = new SQLiteAsyncConnection(DiscogsInsight.DataAccess.Constants.DatabasePath, DiscogsInsight.DataAccess.Constants.Flags); ;
            _logger = logger;
